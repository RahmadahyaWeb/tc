...
$this->params['breadcrumbs'][] = ['label' => 'Manajemen Surat Onilne', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => 'Detail Data Surat', 'url' => ['view', 'id' => $model->id]];
        ...
        <div class="row">
            <div class="col-md-3">
                <?= $form->field(
                    $model,
                    'no_surat',
                )->textInput(['maxlength' => true, 'id' => 'no_surat', 'readonly'=>true]) ?>
            </div>
            <div class="col-md-3">
